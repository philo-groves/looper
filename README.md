...
An experimental continuous AI agent framework based on the PEAS (performance measure, environment, actuators, sensors) architecture from robotics, and its harness is based on the [Fiddlesticks](https://github.com/philo-groves/fiddlesticks) framework.
