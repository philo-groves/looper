export type PerceptStatus = "Pending" | "No Surprise" | "Surprise";
...
type PerceptsPanelProps<TItem extends PerceptListItem> = {
  items: TItem[];
  onClear?: () => void;
...
export function PerceptsPanel<TItem extends PerceptListItem>({
  items,
  onClear,
  onItemClick,
  title = "Percepts",
  emptyText = "No percepts yet.",
}: PerceptsPanelProps<TItem>) {
  return (
