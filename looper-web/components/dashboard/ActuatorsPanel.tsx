import { EditableActuator } from "@/components/dashboard/types";

type ActuatorsPanelProps = {
  actuators: EditableActuator[];
  onAddActuator: () => void;
};

export function ActuatorsPanel({ actuators, onAddActuator }: ActuatorsPanelProps) {
  return (
